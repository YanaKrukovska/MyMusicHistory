...
public class TopSongsFragment6Months extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.top_songs_6months, container, false);
    ...
    private void addTopSongs() {
        ...
        Call<List<ListenAmount>> call = service.getUserTopListens("jana.krua@gmail.com",
                convertToString(addMonth(now, -6)),
                convertToString(now));
